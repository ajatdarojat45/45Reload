...
<div class="container">
   <div class="text-center">
      ...
      <a href="{{route('transaction/index')}}" style="color:#636b6f">/Transactions</a>
                     ...
                     <div class="row">
                        <div class="col-lg-6 col-md-6">
                           <label for="formGroupExampleInput">Search :</label>
									<form class="" action="{{route('transaction/report')}}" method="get">
                        ...
                        <div class="col-lg-12 col-md-12">
                           <div class="text-center table-responsive">
                              ...
                              {!! Charts::multi('bar', 'highcharts')
      									...
      									->setLabels($data['labels'])
      									->setDataset('Distributor Price', $data['distributorPriceValues'])
      									->setDataset('Sell Price', $data['sellPriceValues'])
      									->setDataset('Profit', $data['profitValues'])
      									->setDimensions(1000,500)
      									->setResponsive(false)
      									->render();
      								!!}
